...
const icons = {
  mostlycloudy: {
    black: '../assets/sunny-cloud-icon.svg',
    blue: '../assets/sunny.gif'
  },
  chancerain: {
    black: '../assets/rain-sun-icon.svg',
    blue: '../assets/rain-sun.gif'
  },
  partlycloudy: {
    black: '../assets/cloudy-icon.svg',
  ...
  clear: {
    black: '../assets/sun-icon.svg',
    blue: '../assets/sunny.gif'
  },
  snow: {
    black: '../assets/snow-icon.svg',
    blue: '../assets/snow.gif'
  },
  rain: {
    black: '../assets/rain-icon.svg',
